...
//
//	mockgen -destination=internal/mocks/repository/mock_upload_metadata_repository.go -package=mocks cloudpix/internal/domain/repository UploadMetadataRepository
//
